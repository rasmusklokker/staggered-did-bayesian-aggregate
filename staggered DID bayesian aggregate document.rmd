...
```{r CSA, message=FALSE, warning=FALSE}
...
```{r bayesian aggregation, message=FALSE, warning=FALSE}
...
```{r castle data CSA, message=FALSE, warning=FALSE}
...
```{r castle data bayesian, message=FALSE, warning=FALSE}
...
```{r bayesian aggregation mw, message=FALSE, warning=FALSE}
...
```{r drawing from the posterior, message=FALSE, warning=FALSE}
...
```{r posterior plot, message=FALSE, warning=FALSE}
